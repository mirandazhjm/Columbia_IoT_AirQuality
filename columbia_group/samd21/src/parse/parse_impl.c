...
tenuWifiMode localParseEventLoop(ParseClientInternal *parseClient)
{
	...
	switch (gParseMode)
	{
		...
		/*	deviceConfigAddKey( 0, "applicationId", "App ID", NULL );
			...
			//print_to_terminal("debug_3b (M2M_WIFI_MODE_AP_ENABLE): gParseMode = %d.\r\n", gParseMode);
	...
	/*	case M2M_WIFI_MODE_AP_PROV:
		{
			...
			//print_to_terminal("debug_3b (M2M_WIFI_MODE_AP_PROV): gParseMode = %d.\r\n", gParseMode);
	...
	/*	case M2M_WIFI_MODE_AP:
		{
			...
			{
				print_to_terminal("WIFI : Complete AP Provision\r\n");
			...
			//print_to_terminal("debug_3b (M2M_WIFI_MODE_AP): gParseMode = %d.\r\n", gParseMode);
...
*/
		...
		case M2M_WIFI_MODE_STA_CON:
		{
			if (fluffy_get_wifi_connected())
			{
				...
				{
					print_to_terminal("Error, mDNS Start\r\n");
				}
			...
			//print_to_terminal("debug_3b (M2M_WIFI_MODE_STA_CON): gParseMode = %d.\r\n", gParseMode);
		...
		case M2M_WIFI_MODE_STA:
		{
			...
			//print_to_terminal("debug_3b (M2M_WIFI_MODE_STA): gParseMode = %d.\r\n", gParseMode);
