...
#define HTTP_CLIENT_PARSE_SERVER_URL	"http://52.23.113.79"
#define DEFAULT_PARSE_SERVER_NAME		"52.23.113.79"
#define DEFAULT_PARSE_SERVER_PORT		80 // HTTP port

//#define HTTP_CLIENT_PARSE_SERVER_URL	"http://192.168.1.24"
//#define DEFAULT_PARSE_SERVER_NAME		"192.168.1.24"
//#define DEFAULT_PARSE_SERVER_PORT		3000 // HTTP port
...
static void socket_event_cb(SOCKET sock, uint8_t u8Msg, void *pvMsg)
{
	...
	switch (u8Msg)
	{
		...
		{
			//print_to_terminal("socket_cb: sendto success!\r\n");
			break;
		}
		...
		case SOCKET_MSG_RECV:
		{
			...
			if (pstrRecv && pstrRecv->s16BufferSize > 0)
			{
				...
				/*
				print_to_terminal("recv data : start~~~\r\n");
		...
		{
			//print_to_terminal("socket_cb: recvfrom success!\r\n");
			break;
		}
...
{
	print_to_terminal("WIFI Provision Mode\r\n");
	...
	if (!get_sockinfo_by_socktype(FLUFFY_SOCK_TYPE_AP_SVR))
	{
		...
		{
			print_to_terminal("Error, create AP Server Socket.\r\n");
		}
	}
}*/
...
void fluffy_trans_socket_send_data_for_response(uint8_t sock, char* data)
{
	...
	print_to_terminal("fluffy_trans_socket_send_data_for_response / send data : start~~~\r\n");
