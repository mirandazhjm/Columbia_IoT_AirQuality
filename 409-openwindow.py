...
refer_id = change_id
refer_date = "2016-05-07 23:00:12"
...
def save_data():
	...
	file1 = open('409-open.csv','w')
	file2 = open('409-open.txt','w')
...
def data_proc():
	...
	for ele in ids:
		...
		# file1 = open('409-open-dust.csv','w')
		# csvwriter = csv.writer(file1)
	...
	plt.suptitle('Data on conditon: Cleaning(409) with opening the window')
	# f1 = plt.figure()
	ax1 = plt.subplot(312) 
	# plt.subplot(132)
	...
	plt.figure(2)
	plt.suptitle('Data on condition: Cleaning(409) with opening the window')
	ax3 = plt.subplot(211)
