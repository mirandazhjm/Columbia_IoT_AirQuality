...
def data_proc():
	...
	refer_id = change_id
	refer_date = "2016-05-07 19:21:00"
	...
	# f0 = plt.figure()
	# print len(line_xx)
	# print len(line_y_ransac_co2_1)
	plt.suptitle('Data on conditon: Frying bacon with opening the window')
	ax0 = plt.subplot(311)
...
# +
	# ax0.plot(line_x,line_y, '-r', label='Linear regressor',linewidth=2)
	...
	plt.figure(2)
	plt.suptitle('Data on condition: Frying bacon with opening the window')
	ax3 = plt.subplot(211)
